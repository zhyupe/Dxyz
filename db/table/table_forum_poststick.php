...
class table_forum_poststick extends discuz_table
{
	...
	public function fetch_all_by_tid($tid) {
		return Dxyz_DB::fetch_all('SELECT * FROM %t WHERE tid=%d ORDER BY dateline DESC', array($this->_table, $tid), 'pid');
	}
	...
	public function delete_by_tid($tids) {
		...
		return Dxyz_DB::query('DELETE FROM %t WHERE '.Dxyz_DB::field('tid', $tids), array($this->_table));
	}
