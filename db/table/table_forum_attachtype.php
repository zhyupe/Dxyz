...
class table_forum_attachtype extends discuz_table
{
	...
	public function fetch_all_by_fid($fid) {
		return Dxyz_DB::fetch_all('SELECT * FROM %t WHERE fid=%d', array($this->_table, $fid), $this->_pk);
	}
	...
	public function delete_by_id_fid($id, $fid) {
		...
		return Dxyz_DB::delete($this->_table, Dxyz_DB::field('id', $id).' AND '.Dxyz_DB::field('fid', $fid));
	}
