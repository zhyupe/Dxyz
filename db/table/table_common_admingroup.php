...
class table_common_admingroup extends discuz_table
{
	...
	public function fetch_all_order() {
		return Dxyz_DB::fetch_all("SELECT u.radminid, u.groupid, u.grouptitle FROM ".Dxyz_DB::table('common_admingroup')." a LEFT JOIN ".Dxyz_DB::table('common_usergroup')." u ON u.groupid=a.admingid ORDER BY u.radminid, a.admingid");
	}
}
